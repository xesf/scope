const text = {
	en: {
		...
		scene2_tutorial:
			'Press SHIFT and the Arrow Keys to Rotate Left or Right<br />Put the blue <font color="#7ea6e0">Ball</font> in the green <font color="#97d077">Area</font>',
	...
	pt: {
		...
		scene2_tutorial:
			'Carregue na tecla SHIFT e nas Setas para rodar para a esquerda ou direita<br />Ponha a <font color="#7ea6e0">Bola</font> azul na <font color="#97d077">Área</font> verde',
